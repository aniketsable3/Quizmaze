...
if ($_SERVER["REQUEST_METHOD"]=="POST") {
    ...
    $sql="INSERT INTO `thread` (`username`, `category_description`) VALUES ('$username', '$description');";
...
?>
    ...
    <div class="container">
        ...
        <form action="addpeople.php" method="post">
            ...
            <div class="form-group">
                <label for="category_description">Password</label>
                <input type="username" class="form-control" id="category_description" name="category_description" placeholder="category_description"
                    required>
